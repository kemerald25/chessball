...
describe('Last Games Results Functionality', () => {
  ...
  beforeAll(() => {
    ...
    const supabaseUrl = process.env.SUPABASE_URL || 'https://fbczuemyuopzctgztsxc.supabase.co';
    const supabaseKey = process.env.SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZiY3p1ZW15dW9wemN0Z3p0c3hjIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTg4MTQ2MzEsImV4cCI6MjA3NDM5MDYzMX0.VUSlFSCN7rRtn4fR_ulH_Asw2J1F5Vsv5ZSiVuWnMu0';
